...
class MoneyTransactionsController(
    ...
    fun cancelMoneyBookingOrder(@RequestBody request: CancelMoneyBookingTransactionRequest): ResponseEntity<MoneyBookingTransactionResponse> {
...
data class CancelMoneyBookingTransactionRequest(
